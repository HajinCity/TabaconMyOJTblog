        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-[#C7CCD9] mb-4">
              I am an entrepreneur and developer focused on creating innovative technological solutions. Experienced in building software and mobile applications, with strong skills in both backend and frontend development, including UI and UX design.
            </p>
            <p className="text-[#C7CCD9] mb-4">
              My journey in tech started during my Junior to Senior Highschool years, where I
            ...
            <p className="text-[#C7CCD9]">
              ...
              reading books, travelling, finding clients for projects and sharing my knowledge with the developer community.
            </p>
          </div>
        </div>
