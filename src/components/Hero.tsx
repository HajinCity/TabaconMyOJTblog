      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-6 text-[#F3F4F7]">
            <span className="inline-block">Carlos David A. Tabacon</span>
          </h1>

          {/* Tagline */}
          <p className="text-xl sm:text-2xl md:text-3xl mb-8 text-[#C7CCD9] max-w-3xl mx-auto">
            An{" "}
            <span className="text-[#B5E3FF]">entrepreneur</span> and passionate{" "}
          ...
          <p className="text-[#C7CCD9] mb-12 max-w-2xl mx-auto">
            I specialize in building modern web, desktop and mobile applications with cutting-edge
