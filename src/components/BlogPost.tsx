...
import { Calendar, Clock, User, ArrowLeft, Share2, Twitter, Linkedin, Link as LinkIcon, Facebook, ArrowRight } from "lucide-react";
            ...
            <div className="prose-custom">
              ...
              {(previousPost || nextPost) && (
                <div className="border-t border-b border-[#C7CCD9]/20 py-8 my-12">
                  <div className={`grid gap-6 ${previousPost && nextPost ? 'sm:grid-cols-2' : 'sm:grid-cols-1'}`}>
                    {/* Previous Post */}
                    {previousPost && (
                      <button
