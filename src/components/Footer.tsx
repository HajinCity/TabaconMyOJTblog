...
export function Footer() {
  ...
  const socialLinks = [
    { icon: Github, url: "https://github.com/HajinCity", label: "GitHub" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/carlos-david-tabacon-b545ba28a/", label: "LinkedIn" },
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span>zerocarlos3@gmail.com</span>
              </a>
              <a
                href="tel:+1234567890"
                className="flex items-center gap-3 text-[#C7CCD9] hover:text-[#B5E3FF] transition-colors group"
              ...
              <div className="flex items-center gap-3 text-[#C7CCD9]">
                ...
                <span>Zamboanga Del Sur, Pagadian City, Philippines</span>
              </div>
            </div>
